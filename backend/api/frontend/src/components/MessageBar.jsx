    ...
    return (
        <div className='flex flex-row p-2'>
            ...
            <input
                ...
                type='text'
                placeholder={isMobile ? 'Message @Wingways...' : 'Message @WingWays Risk Management Team'}
            />
            ...
            <button className='flex justify-center items-center bg-teal-600 text-white w-12 rounded-md ml-6'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
