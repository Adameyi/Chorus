...
function GroupInfo({ showGroupChat, setShowGroupChat }) {
                ...
                <div className='m-4 rounded-3xl bg-white p-4'>
                    <div className='flex flex-row justify-between'>
                        ...
                        <div className='flex flex-row'>
                            ...
                            {/* Close Button */}
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => setShowGroupChat(false)} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8">
